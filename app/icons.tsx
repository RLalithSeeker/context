...
export const Bolt = s(<><path d="M13 2 4.5 13.5H11l-1 8.5L19.5 10H13z" /></>);
export const Key = s(<><circle cx="7.5" cy="15.5" r="4.5" /><path d="m10.5 12.5 8-8M16 4l3 3M14 6l3 3" /></>);
export const Chevron = s(<><path d="m6 9 6 6 6-6" /></>);
export const Arrow = s(<><path d="M5 12h14M13 6l6 6-6 6" /></>);
export const Terminal = s(<><path d="m4 17 6-6-6-6M12 19h8" /></>);
export const Layers = s(<><path d="m12 2 9 5-9 5-9-5 9-5z" /><path d="m3 12 9 5 9-5M3 17l9 5 9-5" /></>);
export const Search = s(<><circle cx="11" cy="11" r="7" /><path d="m21 21-4.3-4.3" /></>);
